...
readable_spreadsheet_mapping_with_codes <-
  readable_spreadsheet_mapping %>%
  map(., .f = ~select(., -matches("_index|condition")))

readable_spreadsheet_mapping_with_descriptions_instead_of_icd_cm_codes <-
  readable_spreadsheet_mapping %>%
  map(., .f = ~select(., -matches("_index|icd9cm")) %>% select(matches("condition"), everything()))

readable_spreadsheet_mapping_full <-
  readable_spreadsheet_mapping %>%
...
```{r}
openxlsx::write.xlsx(x=readable_spreadsheet_mapping_with_codes, file = "./processed_ICD_codes/Schnitzer_et_al_2011_ICD_crossmapping_for_appendix_with_icd9cm_codes.xlsx")
openxlsx::write.xlsx(x=readable_spreadsheet_mapping_with_descriptions_instead_of_icd_cm_codes, file = "./processed_ICD_codes/Schnitzer_et_al_2011_ICD_crossmapping_for_appendix_with_condition_descriptions.xlsx")
openxlsx::write.xlsx(x=readable_spreadsheet_mapping_full, file = "./processed_ICD_codes/Schnitzer_et_al_2011_ICD_crossmapping_for_appendix_with_codes_and_descriptions.xlsx")
```
