...
additional_requirements_icd10cm <-
...
The above listed codes are specified in a compact format, using code ranges such as C00-C97, for example. In addition to that, some codes are excluded on the basis of having a particular 6th character code in ICD-10. In order to 
